...
namespace Disk_Scheduling_Algorithm_Simulator_2
{
    internal class Utilities
    {
        ...
        public static void EnableDiskAlgoSelectorCB(ComboBox cb, bool enable)
        {
            cb.Enabled = enable;
        }
        ...
        public static bool CheckInputRange(DataGridView tracksTable)
        {
        ...
        public static void ResetDiskAlgoSelector(ComboBox cb)
        {
            cb.SelectedIndex = -1;
        }
    }
